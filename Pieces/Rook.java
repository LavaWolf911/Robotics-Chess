...
public class Rook extends chessPiece {
    ...
    public Rook(Color color, GridPoint startingPosition, JPanel[][] squares, String name) {
        ...
        try {
            if (isWhite()) {
                this.peiceIMG = createResizedLabel(PieceConstants.imageURLS.wRook.toURL(), 75, 75);
            } else {
                this.peiceIMG = createResizedLabel(PieceConstants.imageURLS.bRook.toURL(), 75, 75);
