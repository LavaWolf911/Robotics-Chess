...
public class Queen extends chessPiece{
    public Queen(Color color, GridPoint startingPosition, JPanel[][] squares, String name){
        ...
        try {
            ...
            squares[startingPosition.getX()][startingPosition.getY()].add(createResizedLabel(PieceConstants.imageURLS.bQueen.toURL(), 75, 75));
            } else {
            squares[startingPosition.getX()][startingPosition.getY()].add(createResizedLabel(PieceConstants.imageURLS.wQueen.toURL(), 75, 75));
            }
