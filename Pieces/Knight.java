...
public class Knight extends chessPiece {
    ...
    public Knight(Color color, GridPoint startingPosition, JPanel[][] squares, String name) {
        ...
        try {
            if (isWhite()) {
                this.peiceIMG = createResizedLabel(PieceConstants.imageURLS.wKnight.toURL(), 75, 75);
            } else {
                this.peiceIMG = createResizedLabel(PieceConstants.imageURLS.bKnight.toURL(), 75, 75);
