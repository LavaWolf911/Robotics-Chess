...
public class Knight extends chessPiece{
    public Knight(Color color, GridPoint startingPosition, JPanel[][] squares, String name){
        ...
        try {
            ...
            squares[startingPosition.getX()][startingPosition.getY()].add(createResizedLabel(PieceConstants.imageURLS.bKnight.toURL(), 75, 75));
            } else {
            squares[startingPosition.getX()][startingPosition.getY()].add(createResizedLabel(PieceConstants.imageURLS.wKnight.toURL(), 75, 75));
            }
